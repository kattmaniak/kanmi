...
public class BlueCoin extends Group
{
    public BlueCoin(double x, double z)
    {
        Cylinder outerCylinder = new Cylinder(4, 1);
        outerCylinder.setMaterial(new PhongMaterial(Color.LIGHTSKYBLUE));
        outerCylinder.setRotate(90);

        Cylinder innerCylinder = new Cylinder(3, 1);
        innerCylinder.setMaterial(new PhongMaterial(Color.DEEPSKYBLUE));
